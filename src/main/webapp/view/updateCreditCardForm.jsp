...
<body>
	...
	<div id="container">
		...
		<form:form action="/account/updatePaymentMethod"
			...
			<div id="leftTable">
				...
				<input type="hidden" name="addressId"
					value="${creditCard.address.id}" />

				<c:choose>
					<c:when test="${isItDefault == true}">This is your default credit card
			...
			<div id="rightTable">
				...
				<br> <input id="billingCheckbox" type="checkbox"
					name="setDefaultAddress" checked> Same as default account
				address
